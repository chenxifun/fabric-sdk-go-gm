...
import (
	...
	caapi "github.com/BSNDA/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric-ca/api"
	calib "github.com/BSNDA/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric-ca/lib"
	...
	"github.com/BSNDA/fabric-sdk-go-gm/pkg/msp/api"
...
func (c *fabricCAAdapter) Enroll(request *api.EnrollmentRequest) ([]byte, error) {
	...
	careq.CSR = &caapi.CSRInfo{}
	careq.CSR.Names = append(careq.CSR.Names, csr.Name{OU: "client"})
