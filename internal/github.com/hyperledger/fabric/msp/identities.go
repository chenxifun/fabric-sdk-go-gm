...
import (
	...
	bccsp "github.com/BSNDA/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/sdkpatch/cryptosuitebridge"
...
func (id *identity) Verify(msg []byte, sig []byte) error {
	...
	hashOpt, err := id.getHashOpt(id.msp.cryptoConfig.SignatureHashFamily) //id.msp.cryptoConfig.SignatureHashFamily)
	if err != nil {
